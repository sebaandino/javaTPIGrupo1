...
public class EditarTecnico extends javax.swing.JFrame {
    ...
    public EditarTecnico(int id_tecnico) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Editar Tecnico");
    ...
    private void btnAltaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAltaActionPerformed
        ...
        control.editarTecnico(t, nombre, apellido, categoria);
    ...
    private void cargarTecnico(int id_tecnico) {
        this.t = control.traerTecnico(id_tecnico);
        txtNombre.setText(t.getNombre());
        txtApellido.setText(t.getApellido());
        Object obj = t.getCategoria();
        cmbCategoria.setSelectedItem(obj);
