...
public class ListaInsidencias extends javax.swing.JFrame {

    Controladora control;
   
    public ListaInsidencias() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Listado de Insidentes:");
    ...
    private void cargarTabla() {
        ...
        List<Insidente> listaInsidentes = control.traerInsidentes();
        
        if(listaInsidentes != null){
            for(Insidente insidente : listaInsidentes){
